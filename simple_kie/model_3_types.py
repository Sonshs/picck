...
from simple_kie.dataset_3_types import ShkDataSet
import numpy as np
import os
...
epochs = 100
batch_size = 1
data_path = 'data/shk/only_points_n_rules_3_types'
output_path = 'saved/kie_model_3_types'
